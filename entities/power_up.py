...
from config.settings import SHIELD_DURATION, RAPID_FIRE_DURATION,HEALTH_POWERUP_AMOUNT,POWER_UP_SPEED,POWER_UP_SCALE
...
class PowerUp(arcade.Sprite):
    ...
    def __init__(self, image, scale=POWER_UP_SCALE , speed=POWER_UP_SPEED):
...
class HealthPowerUp(PowerUp):
    ...
    def __init__(self):
        ...
        self.health_amount = HEALTH_POWERUP_AMOUNT
